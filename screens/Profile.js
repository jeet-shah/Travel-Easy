        ...
        return(
            <ScrollView contentContainerStyle={{alignItems:'center',justifyContent:'center',width:'100%',height:"100%"}}>
                <View style={[styles.container,{width:"100%",height:"100%"}]}>
                    ...
                    <TouchableOpacity onPress={()=>{firebase.auth().signOut().then(()=>{this.props.navigation.navigate('LogIn')})}} style={[styles.button,{marginTop:20,width:'80%',borderColor:'black',borderRadius:10,borderWidth:1,}]}>
