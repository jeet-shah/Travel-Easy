...
export default class TieCatalogue extends React.Component{
    ...
    constructor(props){
        ...
        this.state={
            ...
            image4:this.props.navigation.getParam("details2")['avatar_url1'],
            image5:this.props.navigation.getParam("details2")['avatar_url2'],
            rate:0,
            count:0,
            size:'42',
            ...
            image2:[
                {url:this.props.navigation.getParam("details2")['avatar_url1']}
            ],
            image3:[
                {url:this.props.navigation.getParam("details2")['avatar_url2']}
            ],
            price:0,
            docid:''
        }
