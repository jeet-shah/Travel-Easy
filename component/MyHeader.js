    ...
    render(){
        return(
            <View style={styles.header}>
                <Icon style={{marginLeft:5}} size={40} color='#696969' name='angle-left' type='font-awesome' onPress={()=>{this.props.navigation.navigate('Catalogue1')}} />
                <View style={{width:"70%",paddingLeft:90}}>
